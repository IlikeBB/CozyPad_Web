...
const EXTENSION_KIND: Record<string, FileKind> = {
  ...
  opus: 'audio', oga: 'audio', weba: 'audio',
  mp4: 'video', webm: 'video', mov: 'video', m4v: 'video', mkv: 'video', avi: 'video',
  mpg: 'video', mpeg: 'video', ogv: 'video', wmv: 'video',
  ...
  switch (kind) {
    ...
    case 'audio':
      return (
        <svg {...common}>
          {page}
          <path d="M6.1 10.8H4.9V9.4h1.2L8.5 7v6L6.1 10.8Z" fill={`${color}18`} strokeWidth={1.05} />
          <path d="M10 8.8a1.8 1.8 0 0 1 0 2.4M11.3 7.8a3.4 3.4 0 0 1 0 4.4" strokeWidth={1.05} />
        </svg>
      );
    case 'video':
      return (
        <svg {...common}>
          <rect x="2.4" y="4" width="8.2" height="8" rx="1.1" fill={`${color}18`} />
          <path d="m10.6 7 3-1.7v5.4l-3-1.7Z" fill={`${color}18`} />
          <path d="M5.6 6.2v3.6l3-1.8Z" fill={`${color}22`} strokeWidth={1.05} />
        </svg>
      );
    case 'archive':
      return (
